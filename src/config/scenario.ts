export const scenarioConfig = {
  ...
  captions: [
    ...
    { start: 27, end: 32, speaker: "bank", text: "This is urgent. Stay on the call and complete the transfer now, or your account may be blocked." },
    { start: 33, end: 38, speaker: "customer", text: "I will verify this request through the bank's official helpline first." },
  ]
};
