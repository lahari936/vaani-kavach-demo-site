      ...
      {health?.status === "healthy" ? (
        <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex items-start gap-4 mx-auto max-w-2xl">
          ...
          <div className="space-y-1">
            <h3 className="font-medium text-emerald-800 text-sm">Live detector connected — {health.model_version}</h3>
        ...
        <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex items-start gap-4 mx-auto max-w-2xl">
          ...
          <div className="space-y-1">
            <h3 className="font-medium text-amber-800 text-sm">{health ? "Detector unreachable" : "Checking detector…"}</h3>
                  ...
                  {result?.status === "completed" ? (
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="h-full flex flex-col">
                      <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4">
                        ...
                        <span className="text-[10px] uppercase tracking-widest text-muted-foreground font-medium">{result.status === "not_connected" ? "API Disconnected" : "Rejected"}</span>
                      </div>
                    </motion.div>
                  ) : (
